...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-20">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">
                                {{-- <a href="{{ route('admin.illness-categories.show', $category->slug) }}"  --}}
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end space-x-2">
                                ...
                                <a href="{{ route('admin.illness-categories.edit', $category->slug) }}" 
                                ...
                                @if($category->detail)
                                    <a href="{{ route('admin.illness-categories.details.edit', $category) }}" 
                                ...
                                <!-- Delete Button -->
                                <form action="{{ route('admin.illness-categories.destroy', $category->slug) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
    ...
    <div class="mt-8 bg-white shadow rounded-lg p-8 text-center">
