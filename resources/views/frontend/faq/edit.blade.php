...
@section('pagecontent')
    <style>
        ...
        .delete-btn {
            background: linear-gradient(135deg, hsl(0, 100%, 60%), hsl(0, 100%, 70%));
            color: white;
            ...
            <div class="form-glass rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-800 to-blue-900 p-6">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('faqs.index') }}" class="flex items-center text-blue-200 hover:text-white transition-colors">
                ...
                <div class="p-8">
                    <form action="{{ route('faqs.update', $faq->slug) }}" method="POST">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="flex flex-wrap gap-4 pt-4">
                                <button type="submit" class="update-btn px-8 py-3 rounded-full font-bold flex items-center justify-center gap-2">
                                ...
                                <button type="button" onclick="confirmDelete()" class="delete-btn px-8 py-3 rounded-full font-bold flex items-center justify-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <!-- Delete Form (hidden) -->
                    <form id="delete-form" action="{{ route('faqs.destroy', $faq->slug) }}" method="POST" class="hidden">
                        @csrf
                        @method('DELETE')
                    </form>
                </div>
