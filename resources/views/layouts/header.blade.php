        ...
        <div class="flex justify-between h-18  items-center">
            ...
            <ul class="navbar-ul hidden lg:flex lg:space-x-2 xl:space-x-6 transition-all duration-300">
                <li class="relative group nav-item">
                    <a href="#">
                        <button class="flex items-center justify-center font-semibold px-3 mb-2 focus:outline-none transition-colors duration-300">
                            Home
                        </button>
                    </a>
                </li>
                ...
                <li class="relative group">
                    <a href="#">
                        <button class="flex items-center text-xl font-bold px-3 py-0.5 focus:outline-none transition-colors duration-300">
...
<div id="mobileNavbar" class="fixed top-0 right-0 w-full sm:w-96 h-full transform translate-x-full transition-transform duration-300 z-50 lg:hidden overflow-y-auto">
    <div class="relative bg-center bg-cover h-full" style="background-image: url('{{ asset('bakery/images/main.jpeg') }}');">
        ...
        <div class="relative z-10 h-full">
            ...
            <ul class="mt-4 space-y-2">
                ...
                <li>
                    <a href="#" class="block px-4 py-2 text-lg font-semibold">Menu</a>
                </li>
